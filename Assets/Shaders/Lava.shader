...
Shader "Lava"
{
	...
	SubShader
	{
		...
		{
			float4 color1 = IsGammaSpace() ? float4(0.5849056,0,0,0) : float4(0.301212,0,0,0);
...
/*ASEBEGIN
Version=18900
0;485;1329;514;1209.478;143.6517;1.452188;False;True
Node;AmplifyShaderEditor.ColorNode;1;-312.026,79.98528;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.5849056,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=1648BF6577EE633CE1B16493FF6545BBB2E557F5